...
// Session
app.use(session({
  secret: process.env.SESSION_SECRET || 'phuocthanh-goopy-secret-2025',
  resave: false,
...
app.get('/admin/set-tokens', (_req, res) => {
  res.send(`<!DOCTYPE html><html lang="vi"><head><meta charset="UTF-8"><title>Set Zalo Tokens - Phước Thành</title>
  ...
  <body><h2>Cập nhật Zalo Token - UBND Phước Thành</h2>
...
app.get('/health', (req, res) => {
  res.json({ status: 'ok', project: 'UBND Phước Thành - Góp ý', timestamp: new Date().toISOString() });
});
...
app.listen(CONFIG.PORT, () => {
  console.log(`\n🚀 Server Phước Thành Góp ý chạy tại http://localhost:${CONFIG.PORT}`);
