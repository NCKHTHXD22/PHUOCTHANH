...
// Lịch tạm ngừng cung cấp điện (EVNCPC) — khu vực Điện lực Hiệp Đức (phụ trách Phước Thành)
const powerOutageSchema = new mongoose.Schema({
  subOrgCode:   { type: String, default: '' },   // mã đơn vị điện lực (vd PC05HH)
  subOrgName:   { type: String, default: '' },   // tên đơn vị (vd "Điện lực Hiệp Đức")
