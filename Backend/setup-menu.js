/**
 * Script cài đặt Menu cho Zalo OA "Thông tin xã Phước Thành"
 *
...
// ============================================================
// CẤU HÌNH MENU
// Các item menu cho OA xã Phước Thành + Tra cứu hồ sơ
// ============================================================
const menuConfig = {
  data: [
    {
      ...
      sub_menu: [
        ...
        },
        {
          ...
          type: 'link',
          payload: 'https://phuocthanh.danang.gov.vn',
        },
      ],
    },
    {
      ...
      sub_menu: [
        {
          ...
          type: 'link',
          payload: 'https://example.com/', // TODO: thay bằng link tra cứu ngắt điện của Phước Thành (làm sau, ưu tiên DAWACO cắt nước trước)
        },
        {
          title: '💧 Lịch cắt nước',
          type: 'text',
...
BƯỚC 2: Chọn OA "Thông tin xã Phước Thành"
