      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-slate-50">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden flex flex-col items-center mb-8">
            ...
            <h2 className="text-xl font-bold text-slate-800">UBND Xã Phước Thành</h2>
          </div>
            ...
            {mode === 'login' && (
              <>
                <div className="mb-7">
                  ...
                  <p className="text-slate-400 text-sm mt-1">Dành cho cán bộ UBND Xã Phước Thành</p>
                </div>
                ...
                <p className="text-center text-[11px] text-slate-300 mt-4">
                  Khu vực dành riêng cho cán bộ UBND Xã Phước Thành &bull; Liên hệ quản trị để được hỗ trợ
                </p>
              </>
            )}
